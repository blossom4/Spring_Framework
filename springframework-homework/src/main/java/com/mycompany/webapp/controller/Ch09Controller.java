...
public class Ch09Controller {
	...
	public String fileUpload(String title, String desc, MultipartFile attach) throws Exception {
		logger.info("Run ch09/fileupload");
	...
	public String fileUploadAjax(String title, String desc, MultipartFile attach) throws Exception {
		logger.info("Run ch09/fileUploadAjax");
...
//		String filePath = "C:/Users/cho82/Desktop/blossom/JPA_SpringBoot/spring_upload_files/" + savedname;
...
//	}
	...
	public void filedownload(
		...
		String originalFilename = "blackcat";
		String savedName = "blackcat.jpg";

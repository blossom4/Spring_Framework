...
<body>
		...
		<div class="container" style="margin-top: 15vh;">
		    ...
		    <div class="d-flex justify-content-center">
		    	<a href="/"><img id="errorBlackCat" style="display: block;" alt="error_cat" src="${pageContext.request.contextPath}/resources/images/error_cat.png" 
		    					onmouseover="mouseOver()"></a>
				<a href="/"><img id="errorWhiteCat" style="display: none;" alt="error_cat2" src="${pageContext.request.contextPath}/resources/images/error_cat2.png" 
